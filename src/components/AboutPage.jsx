            ...
            {['About', 'Contact'].map((item, i) => (
              ...
              >
                <Link 
                  ...
                  className={`relative transition-colors ${item === 'About' ? (isDarkMode ? 'text-white' : 'text-gray-900') : (isDarkMode ? 'hover:text-white' : 'hover:text-gray-900')}`}
                >
                  {item}
                  <motion.span
                    className="absolute -bottom-1 left-0 h-[2px] bg-indigo-400"
                    initial={{ width: item === 'About' ? '100%' : 0 }}
            ...
            >
              ...
              <nav className="flex flex-col p-4 space-y-1">
                ...
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.15 }}>
                  <Link to="/about" className={`${textPrimaryClass} ${isDarkMode ? 'bg-white/5' : 'bg-indigo-50'} py-4 px-4 rounded-xl transition-colors text-lg block`} onClick={() => setMobileMenuOpen(false)}>
                    About
                  </Link>
                </motion.div>
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
                  <Link to="/contact" className={`${mobileMenuTextClass} ${isDarkMode ? 'hover:text-white hover:bg-white/5' : 'hover:text-gray-900 hover:bg-gray-100'} py-4 px-4 rounded-xl transition-colors text-lg block`} onClick={() => setMobileMenuOpen(false)}>
                    Contact
                  </Link>
                </motion.div>
                <motion.button
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="mb-12">
              ...
              <p className={`${textSecondaryClass} text-lg leading-relaxed max-w-md`}>
                Lackecity is an AI-powered medical triage platform that helps you understand your symptoms and find the right care, fast.
              </p>
            </motion.div>
